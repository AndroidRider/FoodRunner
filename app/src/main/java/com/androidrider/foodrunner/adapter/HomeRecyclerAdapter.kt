package com.androidrider.foodrunner.adapter
...
import com.androidrider.foodrunner.activity.RestaurantMenuActivity
import com.androidrider.foodrunner.database.RestaurantDatabase
import com.androidrider.foodrunner.database.RestaurantEntity
...
//        val restaurantEntity = RestaurantEntity(restaurant.restaurantId, restaurant.restaurantName)
        ...
        Picasso.get().load(restaurant.restaurantImage).error(R.drawable.pizza).into(holder.txtRestaurantImage)
